...
#LOCAL_SRC_FILES := ../lib/libavcodec-2.2.git.so
LOCAL_SRC_FILES := ../lib/libavcodec-linphone-arm.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE    := ffavutil
#LOCAL_SRC_FILES := ../lib/libavutil-2.2.git.so
LOCAL_SRC_FILES := ../lib/libavutil-linphone-arm.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE    := ffswscale
#LOCAL_SRC_FILES := ../lib/libswscale-2.2.git.so
LOCAL_SRC_FILES := ../lib/libswscale-linphone-arm.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE                    := ndk_h264dec
LOCAL_SHARED_LIBRARIES  := ffavcodec  ffavutil  ffswscale
LOCAL_LDLIBS                    := -llog -lGLESv2
LOCAL_SRC_FILES                 := ndkH264Decode.cpp shaders.c opengles_display.c
